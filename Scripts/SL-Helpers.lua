...
function GetPlayerOptions2LineNames()
	local mods = "Turn,Scroll,7,8,9,10,11,12,13,Attacks,Hide,ReceptorArrowsPosition,LifeMeterType,TargetStatus,TargetBar,GameplayExtras,MeasureCounterPositionX,MeasureCounterPositionY,MeasureCounterStyle,MeasureCounterSize,MeasureCounter,DecentsWayOffs,Vocalization,DensityGraph,LaneCover,ScreenAfterPlayerOptions2"
